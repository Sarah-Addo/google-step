...
public final class FindMeetingQueryTest {
  ...
  public void noOptionsForTooLongOfARequest() {
    ...
    int duration = TimeRange.WHOLE_DAY.getDuration() + 1;
  ...
  @Test
  public void justEnoughRoomFor60Minutes() {
    // Have a 60 minute meeting that fits between 00:00-8:30 and 9:30-24:00
    //
    // Events  : |--A----|   |----A----|
    // Day     : |---------------------|
    // Options :
  ...
  public void everyAttendeeIsConsideredWithOptional() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, /*inclusive*/ true),
